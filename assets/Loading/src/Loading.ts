...
export default class Loading extends cc.Component {
    ...
    listTips = [
        ...
        {
            vi: "LUCKY86 nạp rút nhanh chóng và an toàn!",
            en: "LUCKY86 quick cashin,cashout and alway safety!"
        },
    ]
    start() {
    ...
    startGame() {
        ...
        if (Configs.App.IS_LOCAL == false) {
            Http.get("https://res.ronin99.top/assets/AssetBundleVersion.json", {}, (err, data) => {
