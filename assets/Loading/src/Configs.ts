...
namespace Configs {
    ...
    export class App {
        ...
        static API: string = "https://iportal.ronin99.top/api";
		static API2: string = "https://iportal2.ronin99.top/api";
		static APIROY: string = "https://portal.ronin99.top/api";
        ...
        static readonly HOST_SOCKJS = "https://st.ronin99.top/";
