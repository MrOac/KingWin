...
if (!Configs.Login.IsLogin) {
        ...
        actOpenFB() {
            cc.sys.openURL("https://www.facebook.com/ronin99.top");
        ...
        actOpenZalo() {
            cc.sys.openURL("https://t.me/Lk86Vin");
        }
        actOpenLive() {
            App.instance.openWebView("https://tawk.to/chat/62a75dd3b0d10b6f3e771de9/1g5esd0lm");
        }

        actOpenHotLine() {
            if (cc.sys.isNative) {
                cc.sys.openURL("tel:0702.290.386");
            }
            else {
                App.instance.alertDialog.showMsg("Hotline : 0702.290.386 ");
            }
        }
        ...
        actSupportOnline() {
            ...
            if (!cc.sys.isNative) {
                var url = "https://tawk.to/chat/62a75dd3b0d10b6f3e771de9/1g5esd0lm";
                cc.sys.openURL(url);
                //Tawk_API.toggle();
            }
            else {
