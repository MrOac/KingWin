...
export default class App extends cc.Component {
  ...
  //  public popupGameSBO: PopupGameSBO = null;
    ...
    static DOMAIN = "ronin99.top";
    static API_CMD: string = "https://ga.ronin99.top/3rd/cmd";
    static API_IBC: string = "https://ga.ronin99.top/3rd/ibc";
    static API_SBO: string = "https://ga.ronin99.top/3rd/sbo"
    static API_AG: string = "https://ga.ronin99.top/3rd/ag";
    static API_EBET: string = "https://ga.ronin99.top/3rd/ebet";
    static API_WM: string = "https://ga.ronin99.top/3rd/wm";

    //http://localhost:8081/api?c=2021&nn=tuanbigbird&at=1628224022&ip=127.0.0.1&mn=100
    updateConfigGame(domain = "ronin99.top") {
